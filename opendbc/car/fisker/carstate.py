...
from opendbc.car.fisker.values import FiskerFlags, CAR, DBC, STEER_THRESHOLD, TSS2_CAR, RADAR_ACC_CAR, \
...
class CarState(CarStateBase):
  def __init__(self, CP):
    ...
    if CP.flags & FiskerFlags.SECOC.value:
  ...
  def update(self, can_parsers) -> structs.CarState:
    ...
    if self.CP.flags & FiskerFlags.SECOC.value:
      ...
      if not self.CP.flags & FiskerFlags.DISABLE_RADAR.value:
    ...
    if self.CP.carFingerprint in TSS2_CAR and not self.CP.flags & FiskerFlags.DISABLE_RADAR.value:
